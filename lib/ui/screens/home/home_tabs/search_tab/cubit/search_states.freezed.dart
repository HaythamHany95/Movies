...
mixin _$SearchState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(T searchResults) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(T searchResults)? loaded,
...
abstract class _$$LoadedImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({T searchResults});
}

/// @nodoc
class __$$LoadedImplCopyWithImpl<T, $Res>
    extends _$SearchStateCopyWithImpl<T, $Res, _$LoadedImpl<T>>
...
class _$LoadedImpl<T> implements Loaded<T> {
  const _$LoadedImpl(this.searchResults);

  @override
  final T searchResults;

  @override
  String toString() {
    return 'SearchState<$T>.loaded(searchResults: $searchResults)';
  }
...
abstract class Loaded<T> implements SearchState<T> {
  const factory Loaded(final T searchResults) = _$LoadedImpl<T>;
